...
function ModalAddObjectValidation({apiURL, observer, onClose}: IModal) {
	...
	const {errors, handleSubmit, setValues, values} = useObjectFieldForm({
		initialValues,
		onSubmit,
	});
...
export default function ModalWithProvider({apiURL}: IProps) {
